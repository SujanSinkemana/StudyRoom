...
def home(request):
    ...
    context = {'rooms': rooms, 'topics':topics, 'room_count':room_count, 'room_comments':room_comments}
...
def userProfile(request,pk):
    ...
    context= {'user':user, 'rooms':rooms, 'topics':topics, 'room_comments':room_comments}
